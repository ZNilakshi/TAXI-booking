...
const Login = () => {
  ...
  return (
    sessionStatus !== "authenticated" && (
      <div className="w-full min-h-screen flex items-center justify-center bg-black-100 "  style={{ backgroundImage: "url('https://cdn.create.vista.com/api/media/small/464163046/stock-photo-cheerful-happy-teen-asian-woman-enjoying-shopping-she-carrying-shopping')" }}>
        <div className="w-11/12 md:w-4/5 lg:w-3/6 xl:w-3/6  bg-white rounded shadow-lg overflow-hidden flex">
          ...
          <div className="w-1/2 p-8 bg-yellow-100">
            <h1 className="text-4xl text-center font-semibold mb-8 text-yellow-700">Login</h1>
            ...
            <Link
              className="block text-center text-yellow-700 hover:underline mt-2"
              href="/register"
            >
              Register Here
            </Link>
